...
void NumberSegmentsCDT2d(CDT2d *cdt, unsigned long iCelda, unsigned long nVertices, double *, double *);
void InitCDT2d(CDT2d *cdt, unsigned long iCelda, unsigned long nVertices, double *, double *);
int FreeCDT2d(CDT2d *);
int SetPhiIso(CDT2d *);

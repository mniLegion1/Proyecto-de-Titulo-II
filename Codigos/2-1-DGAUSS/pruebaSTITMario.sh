...
#Isotropic
echo "Iso(L-STIT)", >> Modelo.txt

for((i=0;i<100;i++))
do
./cdt 0 0 60 68 0.1 0.25
...
#Anisotropic
echo "Aniso(L-STIT)", >> Modelo.txt

for((i=0;i<100;i++))
do
./cdt 0 1 65 75 0.1 0.25 3 0 0.334 0.25 0.333 0.5 0.333
...
for((i=0;i<100;i++))
do
./cdt 0 2 65 70 0.1 0.25 3 0 0.334 0.25 0.333 0.5 0.333 0.2
...
#Isotropic
echo "Iso(L-AREA)", >> Modelo.txt

for((i=0;i<100;i++))
do
./cdt 1 0 600 2420 0.1 0.25
...
#Anisotropic
echo "Aniso(L-AREA)", >> Modelo.txt

for((i=0;i<100;i++))
do
./cdt 1 1 600 2420 0.1 0.25 3 0 0.334 0.25 0.333 0.5 0.333
...
for((i=0;i<100;i++))
do
./cdt 1 2 600 2420 0.1 0.25 3 0 0.334 0.25 0.333 0.5 0.333 0.2
